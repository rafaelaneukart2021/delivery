let myPurpleHouse: Sprite;
let myRedHouse: Sprite;
...
//  neighborhood
scene.onOverlapTile(SpriteKind.Player, myTiles.tile3, function on_overlap_tile(sprite: Sprite, location: tiles.Location) {
...
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.Object, function on_on_overlap(sprite2: Sprite, otherSprite: Sprite) {
    music.magicWand.play()
    sprite2.destroy(effects.confetti, 500)
    info.changeScoreBy(1)
})
//  Lose a point for driving into a house
sprites.onOverlap(SpriteKind.Player, SpriteKind.Object, function on_on_overlap2(sprite3: Sprite, otherSprite2: Sprite) {
